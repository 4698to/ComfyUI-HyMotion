...
from .JoeDownloadFile import NODE_CLASS_MAPPINGS as NODE_CLASS_MAPPINGS_JOE, NODE_DISPLAY_NAME_MAPPINGS as NODE_DISPLAY_NAME_MAPPINGS_JOE
from .JoeUploadNPZ import NODE_CLASS_MAPPINGS as NODE_CLASS_MAPPINGS_JOE_UPLOAD_NPZ, NODE_DISPLAY_NAME_MAPPINGS as NODE_DISPLAY_NAME_MAPPINGS_JOE_UPLOAD_NPZ
...
NODE_CLASS_MAPPINGS = {
    ...
    **NODE_CLASS_MAPPINGS_JOE,
    **NODE_CLASS_MAPPINGS_JOE_UPLOAD_NPZ,
}
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    **NODE_DISPLAY_NAME_MAPPINGS_JOE,
    **NODE_DISPLAY_NAME_MAPPINGS_JOE_UPLOAD_NPZ,
}
